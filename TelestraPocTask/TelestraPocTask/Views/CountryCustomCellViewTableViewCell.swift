...
class CountryCustomCellViewTableViewCell: UITableViewCell {
  ...
  func setcellAutolayout()  {
    NSLayoutConstraint.activate([
      ...
      productImage.widthAnchor.constraint(equalToConstant: imageSize.width),
      productImage.heightAnchor.constraint(equalToConstant: imageSize.height),
      ...
      productDescriptionLabel.topAnchor.constraint(equalTo: productNameLabel.bottomAnchor, constant: paddingLeadTop),
