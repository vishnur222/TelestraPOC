...
public class TAReachability {
    
    public typealias NetworkReachable = (TAReachability) -> ()
    public typealias NetworkUnreachable = (TAReachability) -> ()
...
public extension TAReachability {
    ...
    func startNotifier() throws {
        ...
        let callback: SCNetworkReachabilityCallBack = { (reachability, flags, info) in
            ...
            let reachability = Unmanaged<TAReachability>.fromOpaque(info).takeUnretainedValue()
            reachability.flags = flags
        }
        
        var context = SCNetworkReachabilityContext(version: 0, info: nil, retain: nil, release: nil, copyDescription: nil)
        context.info = UnsafeMutableRawPointer(Unmanaged<TAReachability>.passUnretained(self).toOpaque())
...
fileprivate extension TAReachability {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = TAReachability.Connection
